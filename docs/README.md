...
| **[RELEASE_NOTES_0.2.6.md](RELEASE_NOTES_0.2.6.md)** | Everyone | Steering: `a`/`s` were loading and saving the game as well as steering, Attack moves off Space, ports get their records back |
